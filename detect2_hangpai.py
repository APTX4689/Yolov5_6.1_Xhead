...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='weights/yolov5l-6.1_ghost_ACON.pt', help='model.pt path(s)')
    parser.add_argument('--source', type=str, default='6171.jpg', help='file/dir/URL/glob, 0 for webcam')
